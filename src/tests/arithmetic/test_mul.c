...
static s21_decimal result[] = {
    ...
    {{0x00000003, 0x00000000, 0x00000000, 0x00000000}},  // i= 2: 3
    {{0x00000001, 0x00000000, 0x00000000, 0x00050000}},  // i= 3: 0.00001
    ...
    {{0x3424B06F, 0xEBC29F86, 0x14484BFE,
      0x80000000}},  // i=11: -6277101735386680763835789423
    {{0x3424B06F, 0xEBC29F86, 0x14484BFE,
      0x80120000}},  // i=12: -6277101735.386680763835789423
    ...
    {{0x00000000, 0x00000000, 0x00000000,
      0x00000000}},  // i=16: 0.0000000000000000000000000000
};
...
Suite *test_mul(void) {
  Suite *s = suite_create("\033[41m==S21_MUL==\033[0m");
